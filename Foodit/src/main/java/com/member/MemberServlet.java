...
public class MemberServlet extends MyServlet {
	...
	protected void idFindSubmit(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			// 메일로 전송
			String msg = dto.getName() + "님의 아이디는 <span style='color:#88b04B;'><b>" + findId + "</b><span> 입니다. <br>";
	...
	protected void pwdFindSubmit(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			// 메일로 전송
			String msg = dto.getName() + "님의 새로 발급된 임시 패스워드입니다. <span style='color:#88b04B;'><b>" + pwd
					+ "</b><span> 입니다. <br>" + "로그인 후 반드시 패스워드를 변경하시기 바랍니다";
